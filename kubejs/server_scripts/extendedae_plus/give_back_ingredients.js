const items_extendedae_plus = {
  'extendedae_plus:1024x_crafting_accelerator': {
    outputs: ['ae2:cell_component_256k', 'ae2:cell_component_256k', 'extendedae_plus:256x_crafting_accelerator']
  },
...
ItemEvents.rightClicked((event) => {
  ...
  const itemData = items_extendedae_plus[item.id];
  if (itemData) {
    item.count--;
