ServerEvents.recipes(event => {
  const chemical_tanks = [
    ...
    'evolvedmekanism:overclocked_chemical_tank',
    'evolvedmekanism:quantum_chemical_tank',
    'evolvedmekanism:dense_chemical_tank',
  ...
  const fluid_tanks = [
    ...
    'evolvedmekanism:overclocked_fluid_tank',
    'evolvedmekanism:quantum_fluid_tank',
    'evolvedmekanism:dense_fluid_tank',
