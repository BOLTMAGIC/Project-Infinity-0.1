ServerEvents.recipes((event) => {
  event
    .custom({
      ...
      key: {
        ...
        e: {
          ...
          item: 'mekanism:ultimate_fluid_tank',
          count: 1,
          nbt: '{mekData:{FluidTanks:[{stored:{Amount:256000,FluidName:"pneumaticcraft:lpg"}}]}}',
        },
        f: {
          type: 'forge:partial_nbt',
          item: 'mekanism:basic_fluid_tank',
        ...
        j: {
          ...
          item: 'mekanism:basic_fluid_tank',
          count: 1,
          nbt: '{mekData:{FluidTanks:[{stored:{Amount:32000,FluidName:"woot_revived:mob_tears_fluid"}}]}}',
    ...
    .id('mekanism:creative_fluid_tank1');
});
    ...
    .custom({
      ...
      key: {
        ...
        D: {
          ...
          count: 1,
          nbt: '{tank_level:"basic", fluid_id:"thermal_extra:polyolefin"}',
        },
        E: {
          item: 'kubejs:infinity_11',
        },
        ...
        K: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"mekanismgenerators:fusion_fuel"}',
        },
        L: {
          item: 'avaritia:infinity_ingot',
        },
        M: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"mekanism:nutritional_paste"}',
        },
        N: {
          item: 'nuclearcraft:fluid_infuser',
        },
        ...
        P: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"woot_revived:enchanted_fluid"}',
        },
        Q: {
          item: 'extendedcrafting:the_ultimate_ingot',
        },
        R: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"supreme", fluid_id:"minecraft:lava"}',
        },
        S: {
          item: 'nuclearcraft:fluid_enricher',
        },
        T: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"supreme", fluid_id:"mekanism_extras:polonium_containing_solution"}',
        },
        U: {
          type: 'forge:partial_nbt',
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"industrialforegoing:meat"}',
        },
        V: {
          type: 'forge:partial_nbt',
          item: 'extendedcrafting:singularity',
        ...
        X: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"supreme", fluid_id:"mekanism:sodium"}',
        },
        Y: {
          type: 'forge:partial_nbt',
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"crazyae2addons:research_fluid"}',
        },
        Z: {
          item: 'pneumaticcraft:fluid_mixer',
        },
        a: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"supreme", fluid_id:"minecraft:water"}',
        },
        b: {
          type: 'forge:partial_nbt',
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"absolute", fluid_id:"nuclearcraft:polonium"}',
        },
        c: {
          item: 'woot_revived:fluid_infuser',
        },
        ...
        e: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"ultimate", fluid_id:"pneumaticcraft:lpg"}',
        },
        f: {
          type: 'forge:partial_nbt',
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", fluid_id:"exdeorum:witch_water"}',
        },
        g: {
          item: 'trashcans:liquid_trash_can',
        },
        ...
        j: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", fluid_id:"woot_revived:mob_tears_fluid"}',
        ...
        k: {
          ...
          item: 'kubejs:fluid_tank_token',
          count: 1,
          nbt: '{tank_level:"basic", fluid_id:"thermal_extra:paraffin_wax"}',
        },
        l: {
          item: 'actuallyadditions:fluid_placer',
        },
